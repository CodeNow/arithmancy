...
class PostgreStore extends BasePersistentStore {
  ...
  saveMetricEvent (metricEvent) {
    ...
    const tableData = this._formatMetricEventForTable(eventData)
  ...
  _formatMetricEventForTable (metricEvent) {
    return put({
      ...
      time_published: metricEvent.timePublished,
      time_recevied: metricEvent.timeRecevied,
      transaction_id: metricEvent.transactionId,
      publisher_app_name: metricEvent.publisherAppName,
      previous_event_name: metricEvent.previousEventName
    }, metricEvent.tags || {})
  }
